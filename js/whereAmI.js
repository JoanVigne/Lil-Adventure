...
function whereAmI() {
    ...
    switch (iAmHere) {
        ...
        case "The east of the crossroad":
            homeMadeAlert("Woaw", `This water looks deep ! And i sadly never learn how to swim ... <br>
        ...
        case "After the river":
            ...
            if (theLostLandScenario == "1") {
                homeMadeAlert("Woaw", `<p>You really did teleport somewhere else! what magic is that??<br>
